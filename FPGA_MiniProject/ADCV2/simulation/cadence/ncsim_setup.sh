...
# ACDS 17.1 593 win32 2019.04.26.11:51:24
...
# ----------------------------------------
# If ADCV2 is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADCV2_adc_mega_0.v"         -work adc_mega_0 -cdslib ./cds_libs/adc_mega_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ADCV2.v"                                                                                     
fi
